...
To build the final jar and optimize the GatewayAbsaSrv application for production, run:
...
Then navigate to [http://localhost:1909](http://localhost:1909) in your browser.
